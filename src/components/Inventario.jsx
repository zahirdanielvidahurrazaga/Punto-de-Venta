    ...
    <div className="p-4 lg:p-8 h-full overflow-y-auto bg-slate-50">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 lg:gap-4">
          ...
          <button className="bg-white border border-slate-200 px-4 py-3 rounded-xl text-slate-600 font-medium flex items-center justify-center gap-2 hover:bg-slate-50 transition-colors w-full sm:w-auto">
          ...
          <table className="w-full min-w-[800px] text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100 text-slate-500 text-xs lg:text-sm">
                <th className="p-3 lg:p-4 font-semibold w-16">ID</th>
            ...
            <tbody className="text-sm lg:text-base">
              {filteredProducts.map((product) => (
                <tr key={product.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors group">
                  <td className="p-3 lg:p-4 text-slate-400 font-mono">#{product.id}</td>
