    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[70] p-4">
      <div className="bg-slate-100 rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-300 flex flex-col max-h-[95vh]">
        ...
        <div className="p-6 md:p-8 relative overflow-y-auto flex-1 flex flex-col items-center">
          ...
          {/* ----- EL TICKET TÉRMICO ----- */}
          <div id="ticket-termico" className="w-full max-w-sm bg-white shadow-lg relative pb-8 pt-6 px-6 sm:px-8 font-mono text-slate-800" style={{ filter: 'drop-shadow(0 10px 15px rgba(0,0,0,0.05))' }}>
        ...
        <div className="p-4 md:p-6 bg-white border-t border-slate-200 flex flex-col gap-3 shrink-0 z-10">
          <div className="flex gap-3">
            <button
              onClick={() => { handlePrint(); }}
              className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-800 py-3 rounded-xl font-bold transition-colors flex items-center justify-center gap-2 border border-slate-300 btn-premium"
            >
